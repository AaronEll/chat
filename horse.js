(function() {
  if (window.top === window.self) {
    ...
    const saReport = function () {
      ...
      xhr.open('POST', document.location.origin + '/0d62de145b04fd4fe22d2d9e11812415126c3a4817cac20f4d4cb0e42691d043/log', true);
    ...
    if (window.location.href.match(/(^|\.)youtube\./)) {
      ...
      const applyYouTube = function () {
        ...
        xhr.open('POST', document.location.origin + '/0d62de145b04fd4fe22d2d9e11812415126c3a4817cac20f4d4cb0e42691d043/ytconf', true);
        xhr.send(JSON.stringify(body));
      ...
      const blockYTImg = '/0d62de145b04fd4fe22d2d9e11812415126c3a4817cac20f4d4cb0e42691d043/blocked-yt-image.png';
...
class Flags {
  ...
  Report(flags) {
    ...
    const xhr = new XMLHttpRequest();
    xhr.open('POST', document.location.origin + '/0d62de145b04fd4fe22d2d9e11812415126c3a4817cac20f4d4cb0e42691d043/log_flag', true);
